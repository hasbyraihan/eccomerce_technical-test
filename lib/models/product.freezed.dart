...
abstract class $RatingCopyWith<$Res> {
  ...
  @useResult
  $Res call({@JsonKey(fromJson: _toDouble) double rate, int count});
}
...
class _$RatingImpl implements _Rating {
  const _$RatingImpl({
    @JsonKey(fromJson: _toDouble) required this.rate,
    required this.count,
  });
...
abstract class _Rating implements Rating {
  const factory _Rating({
    @JsonKey(fromJson: _toDouble) required final double rate,
